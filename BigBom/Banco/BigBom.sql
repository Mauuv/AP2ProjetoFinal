...
-- Copiando estrutura do banco de dados para bigbom
CREATE DATABASE IF NOT EXISTS `bigbom` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `bigbom`;

-- Copiando estrutura para tabela bigbom.note
CREATE TABLE IF NOT EXISTS `note` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `TransactionId` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `transaction_note_FK` (`TransactionId`),
  CONSTRAINT `transaction_note_FK` FOREIGN KEY (`TransactionId`) REFERENCES `transaction` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Exportação de dados foi desmarcado.

-- Copiando estrutura para tabela bigbom.products
...
-- Copiando estrutura para tabela bigbom.transaction
CREATE TABLE IF NOT EXISTS `transaction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ProductId` int(11) NOT NULL,
  `PurchaseValue` decimal(10,0) NOT NULL,
  `Payment` enum('DINHEIRO','CARTAO CREDITO','CARTAO DEBITO','VALE') NOT NULL,
  `STATUS` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `products_transaction_FK` (`ProductId`),
  CONSTRAINT `products_transaction_FK` FOREIGN KEY (`ProductId`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Exportação de dados foi desmarcado.

-- Copiando estrutura para tabela bigbom.users
...
-- Copiando estrutura para tabela mysql.clientes
